...
{
    QOpenGLFunctions_1_4 *f = QOpenGLVersionFunctionsFactory::get<QOpenGLFunctions_1_4>(QOpenGLContext::currentContext());
    ...
    f->glColor3d (1.0, 0.0, 0.0);
    f->glVertex3d (-size_2, 0.0, -1.0);
    f->glVertex3d ( size_2, 0.0, -1.0);

    f->glVertex3d (-size_2, size_2, -1.0);
    f->glVertex3d ( size_2, size_2, -1.0);

    f->glVertex3d (-size_2, size, -1.0);
    f->glVertex3d ( size_2, size, -1.0);
...
void drawScene(const int size)
{
    ...
    drawTextScroller();
    drawTextFile();
    qDebug() << "Drawscene, array size:" << size;
}
